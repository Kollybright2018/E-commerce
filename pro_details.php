...
// print_r($id);
// die();
$get_pro= mysqli_query($dbc, "SELECT * FROM product WHERE p_id='$id' ");
  ?>
<html lang="en">
<head>
              ...
              <div class="container jumbotron pt-0 mt-0 ">
                ...
                <div class="col-md-4 mt-1">
                   ...
                   <h4 class="item-name text-center"><?php echo $pro['p_name'] ?></h4>
                     ...
                     <p class="price text-center"><b>Description:<br> <?php echo $pro["description"] ?></b></p>
                    
                     <div class="row">
                       <div class="col-md-6">
                       <div class="p-2">
                        <a href="pro_details.php?details=<?php echo $pro['p_id']?>"class="btn btn-primary btn-rounded"> Add to chart</a>
                       </div>               
                       </div>
                       <div class="col-md-6 " >
                       <div class="p-2">
                          <a href="index.php" class="btn btn-success btn-rounded"> Go Back</a>
                       </div>
